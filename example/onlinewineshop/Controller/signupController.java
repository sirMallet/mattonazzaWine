...
public class signupController implements Initializable {
    ...
    public void initialize(java.net.URL location, java.util.ResourceBundle resources) {
        button_Signup.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (!ft_username.getText().isEmpty() && !ft_password.getText().isEmpty() && !ft_Nome.getText().isEmpty()&& !ft_Cognome.getText().isEmpty()&& !ft_Email.getText().isEmpty()&& !ft_CF.getText().isEmpty()&& !ft_NumCell.getText().isEmpty()&& !ft_Indirizzo.getText().isEmpty()) {
                    DBUtilsClient.signUpUsers(event, ft_username.getText(), ft_password.getText(),ft_Nome.getText(), ft_Cognome.getText(),ft_CF.getText(), ft_NumCell.getText(),ft_Email.getText(), ft_Indirizzo.getText());
                }
                else{
        ...
        button_Login.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                DBUtilsClient.changeScene(event,"Login in!","login.fxml",null);
            }
        });
    }
}
